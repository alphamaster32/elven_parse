...
/// Helper type to implement the iterator type on [`ProgramHeader`].
...
impl ProgramHeader {
    ...
    pub fn parse(
        ...
        // Match and parse according to the elf architecture class.
        match class {
            ElfClass::Class32 => {
                ...
                // Get the program offset of the segment in the physical
                // memory. This part is only relevant in systems without
                // which use memory segmentation.
                self.p_paddr =
                    u32::endian_parse(0x0c..0x10, elf, &data)? as usize;
                ...
                self.p_memsz =
                    u32::endian_parse(0x14..0x18, elf, &data)? as usize;

                // Get the memory permissions of the segment.
                let flags =
                    u32::endian_parse(0x18..0x1c, elf, &data)? as usize;
                ...
                // otherwise it should be integral power of 2.
                self.p_align =
                    u32::endian_parse(0x1c..0x20, elf, &data)? as usize;
            }
            ElfClass::Class64 => {
                // Get the memory permissions of the segment.
                ...
                // Specifies alignment
                // 0 and 1 specify no alignment otherwise it should be
                // integral power of 2.
